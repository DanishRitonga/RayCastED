...
PanNuke fold3 evaluation uses `raycasted/evals/eval_pannuke.py`, which computes comprehensive pixel-level and detection metrics using **mask IoU** (not polar IoU):
