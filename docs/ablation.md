...
| 10 | same as Run 7 but QFL (quality focal loss) replaces BCE | — | — | — | — | — | — | — | — | — |
...
- **Run 10 vs Run 7:** Quality focal loss (QFL) replaces BCE with IoU-aware classification targets. Unlike standard focal loss (which was harmful), QFL modulates by quality calibration gap `|IoU - predicted|^γ` rather than `(1-pt)^γ`, strongly penalizing overconfident false positives. Target: precision improvement without the focal loss collapse.
