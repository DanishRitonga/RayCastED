...
Usage:
    ...
    uv run python -m raycasted.evals.train_pannuke --output output/pannuke --epochs 100

    # Individual stages
    uv run python -m raycasted.evals.train_pannuke --output output/pannuke --stage ingest
    uv run python -m raycasted.evals.train_pannuke --output output/pannuke --stage transform
    uv run python -m raycasted.evals.train_pannuke --output output/pannuke --stage train --epochs 50

    # Override training params
    uv run python -m raycasted.evals.train_pannuke --output output/pannuke --batch 8 --imgsz 640 --device 0
"""
